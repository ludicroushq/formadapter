...
Already using shadcn/ui? Follow the [shadcn/ui setup](/docs/ui/shadcn) instead; the form API is identical.
...
- [Use shadcn/ui](/docs/ui/shadcn) when it already owns your application theme.
