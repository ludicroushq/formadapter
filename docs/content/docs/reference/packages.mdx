...
| `@formadapter/shadcn` | Typed Base UI and Radix connectors for your source-owned shadcn/ui components |
...
Import `createShadcn` from `@formadapter/shadcn/baseui` or
`@formadapter/shadcn/radix`, then pass the components generated in your app.
The package ships no component styles.
